...
const HeroBannerThree = () => {
  return (
    <div
      id="uni_hero"
      className="uni-hero  uk-section-2xlarge uk-padding-large-bottom uk-padding-2xlarge-bottom@m uk-panel swiper-parent"
    >
      <div
          ...
          <div className="uk-panel">
            ...
            >
              <div className="uk-width-6-12@m">
                <div
                  className="uk-panel uk-position-z-index uk-text-center"
                ...
                >
                  ...
                  <Dvider />
                  <div
                    className="uk-grid uk-grid-small uk-grid-medium@m uk-flex-center uk-flex-between@m uk-child-width-1-3 uk-margin-medium-top uk-margin-large-top@m"
                    data-uk-grid=""
                  >
                    <div>
                      <div className="uk-panel">
                        <h4 className="uk-h3 uk-h2@m uk-margin-2xsmall uk-font-display">
                          2k+
                        </h4>
              ...
              <div className="uk-width-6-12@m uk-flex-center">
                ...
                >
                  ...
                  />
                  <img
                    className="uk-position-left uk-opacity-10"
                    width="400"
                    src="images/blob-dashed.svg"
                    alt="Blog dashed"
                    style={{ top: "-6%", left: "-16%", fill: "transparent" }}
                  />
                  <img
                    className="uk-position-bottom-right uk-opacity-10"
                    width="400"
                    src="images/blob-dashed.svg"
                    alt="Blog dashed"
                    style={{ bottom: "4%", right: "-16%", fill: "transparent" }}
                  />
